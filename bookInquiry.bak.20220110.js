...
function fSetMode(sNewMode) {
    ...
    if (sTopic === "choose") {
        ...
        if (sMode === 'fetch') {
            ...
            document.getElementById("titleIdInput").style.width = "35px";

            //  disable all book fields except Book ID .................................................................

            fDisableBookFields("titleIdInput", "nameInput", "authorIdInput", "authorInput", "sourceIdInput", "sourceInput"
                             , "seriesIdInput", "seriesInput", "genreIdInput", "genreInput", "statusIdInput", "statusInput"
                             , "clsfnIdInput", "clsfnInput", "ratingIdInput", "ratingInput", "startInput", "finishInput"
                             , "cmntsArea", "chrsArea");
            ...
            document.getElementById("authorInput").value = 'Unassigned';
            fPopulateLOVId('authors');
            
            document.getElementById("sourceInput").value = 'Unassigned';
            fPopulateLOVId('sources');
            
            document.getElementById("seriesInput").value = 'Unassigned';
            fPopulateLOVId('series');

            document.getElementById("genreInput").value = 'Unassigned';
            fPopulateLOVId('genres');

            document.getElementById("statusInput").value = 'Unassigned';
            fPopulateLOVId('statuses');

            document.getElementById("clsfnInput").value = 'Unassigned';
            fPopulateLOVId('classifications');

            document.getElementById("ratingInput").value = 'Unassigned';
...
async function fonclick_submit_submit() {
    ...
    if ((aTopicsToFetch.includes(sTopic)) && sMode === "fetch") {
        ...
        let sBookName = document.getElementById("nameInput").value;
        let sBookAuthorId = document.getElementById("authorIdInput").value;
        let sBookSourceId = document.getElementById("sourceIdInput").value;
        let sBookSeriesId = document.getElementById("seriesIdInput").value;
        let sBookGenreId = document.getElementById("genreIdInput").value;
        let sBookStatusId = document.getElementById("statusIdInput").value;
        let sBookClsfnId = document.getElementById("clsfnIdInput").value;
        let sBookRatingId = document.getElementById("ratingIdInput").value;
        let sBookStart = document.getElementById("startInput").value;
        let sBookFinish = document.getElementById("finishInput").value;
        let sBookCmnts = document.getElementById("cmntsArea").value;
        ...
        if (response.ok) {
            let text = await response.text();
            document.getElementById("titleIdInput").value = text;
            document.getElementById("submit:mssge").value = 'Book added';
            fSetElement("Disable", "submit:submit");
            fSetElement("Disable", "titleIdInput");
            fSetElement("Disable", "nameInput");
            fSetElement("Disable", "authorInput");
            fSetElement("Disable", "sourceInput");
            fSetElement("Disable", "seriesInput");
            fSetElement("Disable", "genreInput");
            fSetElement("Disable", "statusInput");
            fSetElement("Disable", "clsfnInput");
            fSetElement("Disable", "ratingInput");
            fSetElement("Disable", "startInput");
            fSetElement("Disable", "finishInput");
            fSetElement("Disable", "cmntsArea");
        } else {
            alert("HttpError: " + response.status);
        }
...
async function fGetBookDetails() {
    ...
    if (response.ok) {
        ...
        if (arrayFields[1] != undefined) {
            ...
            document.getElementById("authorIdInput").value = arrayFields[2];
            document.getElementById("authorInput").value = arrayFields[3];
            document.getElementById("sourceIdInput").value = arrayFields[4];
            document.getElementById("sourceInput").value = arrayFields[5];
            document.getElementById("seriesIdInput").value = arrayFields[6];
            document.getElementById("seriesInput").value = arrayFields[7];
            document.getElementById("statusIdInput").value = arrayFields[8];
            document.getElementById("statusInput").value = arrayFields[9];
            document.getElementById("genreIdInput").value = arrayFields[10];
            document.getElementById("genreInput").value = arrayFields[11];
            document.getElementById("clsfnIdInput").value = arrayFields[12];
            document.getElementById("clsfnInput").value = arrayFields[13];
            document.getElementById("ratingIdInput").value = arrayFields[14];
            document.getElementById("ratingInput").value = arrayFields[15];
            document.getElementById("startInput").value = arrayFields[16];
            document.getElementById("finishInput").value = arrayFields[17];
            document.getElementById("cmntsArea").value = arrayFields[18];
        } else {
...
async function fGetBookCharacters() {
    ...
    let arrayCharacters = [];
    let sNewText = '';
    let sRequest = uri03 + '?' + 'TitleID=' + document.getElementById("titleIdInput").value + "&Filter=''";
    let response = await fetch(sRequest);
    if (response.ok) {
        let text = await response.text();
...
function fClearBookDivElements() {
    ...
    let arrayOfClears = ["nameInput", "authorIdInput", "authorInput", "sourceIdInput", "sourceInput"
                       , "seriesIdInput", "seriesInput" , "genreIdInput", "genreInput", "statusIdInput", "statusInput"
                       , "clsfnIdInput", "clsfnInput", "ratingIdInput", "ratingInput", "startInput" , "finishInput"
                       , "cmntsArea", "chrsArea"];
    for(let i = 0; i < arrayOfClears.length; i++) {
...
async function fPopulateLOV(strAttribute) {
    ...
    if (strAttribute == 'authors') {
        ...
        const y = document.getElementById("sourceInput");
        ...
        const y = document.getElementById("seriesInput");
        ...
        const y = document.getElementById("genreInput");
        ...
        const y = document.getElementById("statusInput");
        ...
        const y = document.getElementById("clsfnInput");
        ...
        const y = document.getElementById("ratingInput");
...
function fPopulateLOVId(strAttribute) {
    ...
    if (strAttribute == 'authors') {
        ...
        for (let i = 0; i < arrAuthorNames.length; i++) {
            ...
            if (arrAuthorNames[i][1] == document.getElementById("authorInput").value) 
            {
                document.getElementById("authorIdInput").value = arrAuthorNames[i][0].trim();
                break;
            }
        }
        ...
        for (let i = 0; i < arrSourceNames.length; i++) {
            ...
            if (arrSourceNames[i][1] == document.getElementById("sourceInput").value) 
            {
                document.getElementById("sourceIdInput").value = arrSourceNames[i][0].trim();
                break;
            }
        }
        ...
        for (let i = 0; i < arrSeriesNames.length; i++) {
            ...
            if (arrSeriesNames[i][1] == document.getElementById("seriesInput").value) 
            {
                document.getElementById("seriesIdInput").value = arrSeriesNames[i][0].trim();
                break;
            }
        }
        ...
        for (let i = 0; i < arrGenreNames.length; i++) {
            ...
            if (arrGenreNames[i][1] == document.getElementById("genreInput").value) 
            {
                document.getElementById("genreIdInput").value = arrGenreNames[i][0].trim();
                break;
            }
        }
        ...
        for (let i = 0; i < arrStatusNames.length; i++) {
            ...
            if (arrStatusNames[i][1] == document.getElementById("statusInput").value) 
            {
                document.getElementById("statusIdInput").value = arrStatusNames[i][0].trim();
                break;
            }
        }
        ...
        for (let i = 0; i < arrClassificationNames.length; i++) {
            ...
            if (arrClassificationNames[i][1] == document.getElementById("clsfnInput").value) 
            {
                document.getElementById("clsfnIdInput").value = arrClassificationNames[i][0].trim();
                break;
            }
        }
        ...
        for (let i = 0; i < arrRatingNames.length; i++) {
            ...
            if (arrRatingNames[i][1] == document.getElementById("ratingInput").value) 
            {
                document.getElementById("ratingIdInput").value = arrRatingNames[i][0].trim();
                break;
            }
        }
